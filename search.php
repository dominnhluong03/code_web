                    ...
                    <div class="row" style="margin-top: 50px;">
                            <?php
                                if (isset($_GET["search_product"])) {
                                    $name_product = isset($_GET["search"]) ? $_GET["search"] : '';
                                    
                                    if (empty($name_product)) {
                                        echo '<p style="color: red; text-align: center; margin-top: -30px;">Vui lòng nhập từ khóa tìm kiếm</p>';
                                    } else {
                                        ...
                                        if (mysqli_num_rows($result_search) > 0) {
                                            while ($movies = mysqli_fetch_assoc($result_search)) {
                                                ...
                                                echo '<p style="color: red; text-align: center;">Không có dữ liệu phù hợp</p>';
                                            }
                                    }
                                }
                            ?>
