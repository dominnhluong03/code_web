            ...
            <div class="row">
                ...
                <div class="col-r col-md-6 col-sm-12 col-xs-12">
                    ...
                    <?php
                            ...
                            if (mysqli_num_rows($result_movies) > 0) {
                                while ($movies = mysqli_fetch_assoc($result_movies)) {
                                echo"<a href='' style='color: #820012;'>";
                    ...
                    <div class="selector">
                        ...
                        <br>
                        <select style="width: 200px;" name="" id="" require>
                    ...
                    <div class="add_cart">
                        <form action="cart.php" method="get">
                            ...
                            <input type="hidden" name="product_id" value="<?php echo $this_id; ?>">
                            <button type="submit" id="add-to-cart" class="add-to-cartProduct btn-addtocart addtocart-modal" name="add">Mua ngay</button>
                            <button type="button" id="add-to-cartnew">Thêm vào giỏ</button>
